                ...
                <div className="flex items-center justify-between border-b pb-4">
                  <div>
                    <div className="mb-2 flex items-center">
                      {invoice.customers?.image_url ? (
                        <Image
                          src={invoice.customers.image_url}
                          className="mr-2 rounded-full"
                          width={28}
                          height={28}
                          alt={`${invoice.customers?.name || 'Customer'}'s profile picture`}
                        />
                      ) : (
                    ...
                    <p className="text-sm text-gray-500">{invoice.customers?.email || 'No email'}</p>
                  </div>
              ...
              {invoices?.map((invoice) => (
                ...
                >
                  ...
                  <td className="whitespace-nowrap px-3 py-3">
                    {invoice.customers?.email || 'No email'}
                  </td>
                  <td className="whitespace-nowrap px-3 py-3">
                    {formatCurrency(invoice.amount)}
                  </td>
